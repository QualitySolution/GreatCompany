...
[Appellative(Nominative = "факт прихода", NominativePlural = "факт - приход")]
public class ActualIncome : PropertyChangedBase, IDomainObject {
	...
	int? plannedIncomeId;
	public virtual int? PlannedIncomeId { get => plannedIncomeId; set => SetField(ref plannedIncomeId, value); }
}

public class ActualIncomeRow {
