...
public class ActualIncomeJournalViewModel : JournalViewModelBase<ActualIncomeRow> {
	...
	public ActualIncomeJournalViewModel(Repository repo, INavigationManager navigation) : base(navigation) {
		this.repo = repo;
		Title = "Факт - приход";
	...
	protected override void Delete(ActualIncomeRow row) { repo.Delete<ActualIncome>(row.Id); Reload(); }
